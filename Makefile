...
SOURCEFILES := GPSWork.cpp I2CLCD.cpp JsCPPUtils/Common.cpp JsCPPUtils/Daemon.cpp JsCPPUtils/Logger.cpp JsEmbeddedUtils/I2CDevice.cpp main.cpp ntpqmod.c
EXTERNAL_LIBS := 
...
$(BINARYDIR)/I2CDevice.o : JsEmbeddedUtils/I2CDevice.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
